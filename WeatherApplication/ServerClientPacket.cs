...
namespace DataPackets
{
    ...
    public class WeatherData
    {
        ...
        public string weatherType; //nothing such as weather type is returned from the API
        ...
        public WeatherData(string weatherType, string temperature, string temperatureFeelsLike, string pressure, string humidity, string visibility, string windSpeed, string degree, string sunrise, string sunset, string timezoneFromUTC)
        {
            this.weatherType = weatherType;
            ...
            double windDir = double.Parse(degree);
        ...
        public override string ToString()
        {
            return this.weatherType + "," + this.temperature + "," + this.temperatureFeelsLike + "," + this.pressure + "," + this.humidity + "," + this.visibility + "," + this.windSpeed + "," + this.degree + "," + this.sunrise + "," + this.sunset + "," + this.timezoneFromUTC;
        }

        public string ToPrintable()
        {
            return "Weather Data:\n" + "Weather Type: " + this.weatherType + "\nTemperature: " + this.temperature + "°C\nFeels Like: " + this.temperatureFeelsLike + "°C\nPressure: " + this.pressure + " hPa\nHumidity: " + this.humidity + "%\nVisibility: " + this.visibility + "%\nWind Speed: " + this.windSpeed + " km/h\nWind Direction: " + this.degree + "\nSunrise Time: " + this.sunrise + "\nSunset Time: " + this.sunset + "\n";
        }
    }
    ...
    public class ServerClientPacket
    {
        ...
        public ServerClientPacket(string sourceIP, string destinationIP, int numberOfPackets, int dataLength, string weatherType, string temperature, string temperatureFeelsLike, string pressure, string humidity, string visibility, string windSpeed, string degree, string sunrise, string sunset, string timezoneFromUTC)
        {
            this.head = new Head(sourceIP, destinationIP, numberOfPackets, dataLength);
            this.data = new WeatherData(weatherType, temperature, temperatureFeelsLike, pressure, humidity, visibility, windSpeed, degree, sunrise, sunset, timezoneFromUTC);
        }
